...
CREATE TABLE IF NOT EXISTS Wall_Section(
    ...
    wall_image_url VARCHAR(250),
    image_object_name VARCHAR(250),

    CONSTRAINT chk_wall_img_obj
        CHECK ((image_object_name IS NOT NULL AND wall_image_url IS NOT NULL)
            OR
               (image_object_name IS NULL AND wall_image_url IS NULL)
        )
);
...
CREATE TABLE IF NOT EXISTS Climbing_Problem(
    ...
    CONSTRAINT chk_img_obj
        CHECK ( (image_object_name IS NOT NULL AND problem_image_url IS NOT NULL)
            OR
                (image_object_name IS NULL AND problem_image_url IS NULL)
        )
);
...
INSERT INTO Gym_Action (action_definition)
    VALUES ('CREATE_BETA'), ('DELETE_BETA'), ('CREATE_COMMENT'),
           ('DELETE_COMMENT'), ('CREATE_PROBLEM'), ('DELETE_PROBLEM'),
           ('RESET_WALL'), ('CREATE_WALL'), ('DELETE_WALL'),
           ('CHANGE_ROLE'), ('GRADE_PROBLEM'), ('VIEW_ACCOUNTS'),
           ('VIEW_REPORTS'), ('MODERATE_REPORT'), ('VIEW_MODERATION_LOGS'),
           ('VIEW_APPEALS'), ('MODERATE_APPEAL'), ('UPLOAD_WALL_IMAGE'),
           ('UPLOAD_PROBLEM_IMAGE'), ('UPDATE_CLIMB_INFO'), ('UPDATE_WALL_INFO');
