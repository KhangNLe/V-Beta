...
![Domain Class Diagram](./domain-name/Domain-Name-Diagram.png)

## Use Case Diagram

- File: `use-case/use-case-diagram.png`

![Use Case Diagram](./use-case/use-case-diagram.png)

## Use Case Scenarios

- File: `user-case-scenarios/use-case-scenarios.png`

![Use Case Scenarios](./user-case-scenarios/use-case-scenarios.png)

## Robustness Diagram

- File: `robustness/robustness.png`

![Robustness Diagram](./robustness/robustness.png)

## Sequence Diagram

- File: `sequence/sequence-diagram.png`

![Sequence Diagram](./sequence/sequence-diagram.png)

## Class Diagram

- File: `class/uml_class.png`

![Class Diagram](./class/uml_class.png)

## Database Diagram

- File: `database/database.png`

![Database Diagram](./database/database.png)
