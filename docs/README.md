...
- [`features/wall-problem-images.md`](./features/wall-problem-images.md) (Sprint 6 — complete)
- [`sprints/wall-problem-images.md`](./sprints/wall-problem-images.md) (Sprint 6 contract)
